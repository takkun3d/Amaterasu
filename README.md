![Python 3.9+](https://img.shields.io/badge/Python-3.7%2B-3776AB?logo=python&logoColor=white)
...
## License
本ソフトウェアは MIT ライセンス のもとで公開されています。
詳細は [LICENSE](./LICENSE) をご覧ください。

### 要約
* **Copyright (c) 2014-2026 takkun (takkun3d)**
* **許可:** 商用利用、修正、配布、プライベートでの利用（全部OK）
* **条件:** 著作権表示とライセンス条文を含めること
* **免責:** 作者はこのソフトウェアの使用に関して一切の責任を負いません
